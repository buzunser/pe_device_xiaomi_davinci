...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/prebuilts/default-permissions/enhancer.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/default-permissions/enhancer.xml \
    $(LOCAL_PATH)/prebuilts/permissions/privapp_whitelist_com.google.android.as.oss.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp_whitelist_com.google.android.as.oss.xml \
    $(LOCAL_PATH)/prebuilts/permissions/privapp_whitelist_com.google.android.as.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp_whitelist_com.google.android.as.xml \
    $(LOCAL_PATH)/prebuilts/GoogleCamera_6gb_or_more_ram.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/GoogleCamera_6gb_or_more_ram.xml
